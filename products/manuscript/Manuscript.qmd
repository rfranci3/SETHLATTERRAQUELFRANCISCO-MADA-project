...
_We have 126 observations taken over a period of 2 years. We are evaluating for the presence and burden of antimicrobial resistance genes in white stork feces. Codebook is a WIP located in raw data folder._

## Questions/Hypotheses to be addressed
_Does landfill use by storks increase the likelihood of carrying Antimicrobial resistance (AMR) genes and resistance gene burden?._

_Stork that visit the landfill more often will have a higher likelihood of carrying AMR genes and have a higher burden of AMR genes._

_Is nest success related to AMR gene burden and multi-drug resistance (i.e., resistance to 3 or more drug classes)?_

_Stork with more AMR gene burdens and multi-drug resistance will have lower nest success._
...
raw <- read_csv(here('data/raw_data/StorkAMRraw_2020_2021.csv'))
...
_Basic summary statistics will be performed. Models will be built and fitted to data using the statistical package lme4 in Program R. We will evaluated model fit for all models using Akaike Information Criterion scores adjusted for small sample sizes. The best fit model was selected by having a ΔAICc < 2._
