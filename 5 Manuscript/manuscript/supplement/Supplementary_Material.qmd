...
Contained below are additional results from both the exploratory and full analyses.
...
![Figure 6. Cost-complexity Parameter Plot](Supplementary_Material_files/autoplot.png)
Results from the finalized tree model can be found in Figure 7.
