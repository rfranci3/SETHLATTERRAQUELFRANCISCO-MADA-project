...
#Tiff 
png(file = here('5 Manuscript','manuscript','supplement', 'Supplementary_Material_files', 'glmer_indices.png'))
glmer_indices
dev.off() 
```
...
png(file = here('5 Manuscript','manuscript','supplement', 'Supplementary_Material_files', 'lmer_indices.png'))
lmer_indices
dev.off() 
